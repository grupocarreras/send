...
sendYourFilesLink = Chak'amb'ejaj Carreras Send
...
notSupportedOutdatedDetail = Chakuyu' we okib'al rech Firefox man kutoq'aj ta le k'ak'eta'm rech web' le kuya' uchuq'ab' Carreras Send. Rajawaxik kak'ak'arisaj le anik'onel.
...
javascriptRequired = Le Carreras Send kajawataj JavaScript chech
whyJavascript = ¿jasche kajawataj JavaScript chech  Carreras Send?
