...
sendYourFilesLink = Experimente o Carreras Send
...
notSupportedOutdatedDetail = Infelizmente essa versão do Firefox não suporta a tecnologia web que faz o Carreras Send funcionar. Você precisa atualizar o seu navegador.
...
whyJavascript = Por que o Carreras Send precisa do JavaScript?
