...
notSupportedOutdatedDetail = Dessverre støttar ikkje denne versjonen av Firefox nett-teknologien som driv Carreras Send. Du må å oppdatere nettlesaren din.
...
javascriptRequired = Carreras Send krev JavaScript.
whyJavascript = Kvifor krev Carreras Send JavaScript?
