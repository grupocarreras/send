...
sendYourFilesLink = Ensajar Carreras Send
...
notSupportedOutdatedDetail = Aquesta version de Firefox es pas compatibla amb la tecnologia web amb la quala fonciona Carreras Send. Vos cal metre a jorn lo navegador.
...
javascriptRequired = Carreras Send requesís JavaScript
whyJavascript = Perque Carreras Send requesís JavaScript ?
