...
sendYourFilesLink = Rhowch gynnig ar Carreras Send
...
notSupportedOutdatedDetail = Yn anffodus, nid yw'r fersiwn yma o Firefox yn cynnal y technoleg gwe sy'n gyrru Carreras Send. Bydd angen i chi ddiweddaru eich porwr.
...
javascriptRequired = Mae Carreras Send angen JavaScript
whyJavascript = Pam fod Carreras Send angen JavaScript?
