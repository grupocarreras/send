...
sendYourFilesLink = Carreras Send’i deneyin
...
notSupportedOutdatedDetail = Kullandığınız Firefox sürümü Carreras Send için gereken web teknolojilerini desteklemiyor. Tarayıcınızı güncellemeniz gerekiyor.
...
javascriptRequired = Carreras Send için JavaScript gerekir
whyJavascript = Carreras Send neden JavaScript kullanıyor?
