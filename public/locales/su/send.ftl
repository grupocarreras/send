...
sendYourFilesLink = Pecakan Carreras Send
...
notSupportedOutdatedDetail = Hanjakal Firefox vérsi ieu teu ngarojong téhnologi wéb nu ngagerakkeun Carreras Send. Anjeun perlu ngapdét panyungsi anjeun.
...
javascriptRequired = Carreras Send merlukeun JavaScript
whyJavascript = Naha Carreras Send merlukeun JavaScript?
