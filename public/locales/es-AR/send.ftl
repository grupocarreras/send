...
sendYourFilesLink = Probá Carreras Send
...
notSupportedOutdatedDetail = Desafortunadamente esta versión de Firefox no soporta la tecnología web que necesita Carreras Send. Necesitás actualizar el navegador.
...
whyJavascript = ¿Por qué Carreras Send requiere Java Script?
