...
sendYourFilesLink = Wypróbuj Carreras Send
...
notSupportedOutdatedDetail = Ta wersja Firefoksa nie obsługuje technologii internetowej, która napędza Carreras Send. Należy uaktualnić przeglądarkę.
...
javascriptRequired = Carreras Send wymaga języka JavaScript
whyJavascript = Dlaczego Carreras Send wymaga języka JavaScript?
