...
sendYourFilesLink = Փորձել Carreras Send-ը
...
notSupportedOutdatedDetail = Դժբախտաբար, Firefox- ի այս տարբերակը չի աջակցում այն վեբ տեխնոլոգիան, որը պետք է Carreras Send-ի համար: Դուք պետք է թարմացնեք ձեր զննարկիչը:
...
javascriptRequired = Carreras Send-ը պահանջում է JavaScript
whyJavascript = Ինչո՞ւ է Carreras Send-ը պահանջում JavaScript.
