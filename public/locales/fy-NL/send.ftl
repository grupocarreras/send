...
sendYourFilesLink = Carreras Send probearje
...
notSupportedOutdatedDetail = Spitigernôch stipet dizze ferzje fan Firefox de webtechnology dy't Carreras Send mooflik makket net. Jo moatte jo browser fernije.
...
javascriptRequired = Carreras Send fereasket JavaScript.
whyJavascript = Werom hat Carreras Send JavaScript nedich?
