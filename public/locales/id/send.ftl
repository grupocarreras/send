...
sendYourFilesLink = Coba Carreras Send
...
notSupportedOutdatedDetail = Sayangnya Firefox versi ini tidak mendukung teknologi web yang menggerakkan Carreras Send. Anda perlu memperbarui peramban Anda.
...
javascriptRequired = Carreras Send membutuhkan JavaScript.
whyJavascript = Mengapa Carreras Send membutuhkan JavaScript?
