...
sendYourFilesLink = Ni´i Carreras Send
...
notSupportedOutdatedDetail = Tuni Firefox ya´a ntu satiñu vii jii Carreras Send. Nejika xinunu a jíía ka̱a̱ nánuku.
...
javascriptRequired = Carreras Send ni´i JavaScript
whyJavascript = ¿Navi Carreras Send ni´i JavaScript?
