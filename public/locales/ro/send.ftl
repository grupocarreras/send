...
sendYourFilesLink = Încearcă Carreras Send
...
notSupportedOutdatedDetail = Din păcate, această versiune de Firefox nu suportă tehnologiile web din spatele Carreras Send. Va trebui să actualizezi browserul.
...
javascriptRequired = Carreras Send necesită JavaScript
whyJavascript = De ce Carreras Send necesită JavaScript?
