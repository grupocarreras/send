...
sendYourFilesLink = Kokeile Carreras Send -palvelua
...
notSupportedOutdatedDetail = Valitettavasti tämä Firefoxin versio ei tue Carreras Sendiä käyttävää web-tekniikkaa. Sinun on päivitettävä selaimesi.
...
whyJavascript = Miksi Carreras Send vaatii JavaScriptin?
