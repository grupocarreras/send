...
sendYourFilesLink = Probatu Carreras Send
...
notSupportedOutdatedDetail = Zoritxarrez Firefox bertsio honek ez du Carreras Send-ek behar duen web teknologia onartzen. Zure nabigatzailea eguneratu behar duzu.
...
javascriptRequired = JavaScript beharrezkoa da Carreras Send erabiltzeko.
whyJavascript = Zergatik behar du Carreras Send-ek JavasScript?
