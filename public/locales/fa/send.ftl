...
sendYourFilesLink = Carreras Send را امتحان کنید
...
notSupportedOutdatedDetail = متاسفانه این نسخه از فایرفاکس این تکنولوژی وب که به Carreras Send قدرت می‌بخشد را پشتیبانی نمی‌کند. شما نیاز دارید تا مرورگر خود را بروز کنید.
...
javascriptRequired = Carreras Send نیازمند جاوااسکریپت است
whyJavascript = چرا Carreras Send جاوااسکریپت لازم داد؟
