...
sendYourFilesLink = Ɛreḍ Carreras Send
...
notSupportedOutdatedDetail = Ad nesḥissef imilqem-agi n Firefox Firefox ur isefrak ara titiknulujiyin web yettwaseqdacen di Carreras Send. Yessefk ad tleqmeḍ iminig-ik.
...
javascriptRequired = Carreras Send yesra JavaScript
whyJavascript = Ayɣer Carreras Send yesra JavaScript?
