...
sendYourFilesLink = Preba Carreras Send
...
notSupportedOutdatedDetail = Esta versión de Firefox no admite la tecnolochía web con que funciona lo Carreras Send. Habrás d'esviellar lo navegador.
...
javascriptRequired = Carreras Send necesita JavaScript
whyJavascript = Per qué Carreras Send necesita JavaScript?
