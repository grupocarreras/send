...
sendYourFilesLink = Carreras Sendను ప్రయత్నించండి
...
javascriptRequired = Carreras Sendకి జావాస్క్రిప్టు కావాలి
whyJavascript = Carreras Sendకి జావాస్క్రిప్టు ఎందుకు కావాలి?
