...
sendYourFilesLink = Proovi Carreras Send'i
...
notSupportedOutdatedDetail = Kahjuks ei toeta see Firefoxi versioon veebitehnoloogiaid, mis teevad Carreras Sendi toimimise võimalikuks. Sa pead oma brauserit uuendama.
...
javascriptRequired = Carreras Send'i kasutamiseks tuleb JavaScript lubada
whyJavascript = Miks Carreras Send JavaScripti vajab?
