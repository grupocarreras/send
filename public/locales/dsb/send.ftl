...
sendYourFilesLink = Carreras Send wopytaś
...
notSupportedOutdatedDetail = Bóžko toś ta wersija Firefox webtechnologiju njepódpěra, na kótarejž Carreras Send bazěrujo. Musyśo swój wobglědowak aktualizěrowaś.
...
whyJavascript = Cogodla Carreras Send JavaScript trjeba?
