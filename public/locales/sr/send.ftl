...
sendYourFilesLink = Испробајте Carreras Send
...
notSupportedOutdatedDetail = Нажалост, ово издање Firefox-a не подржава веб технологију која омогућава Carreras Send. Мораћете да ажурирате ваш прегледач.
...
javascriptRequired = За Carreras Send је потребан JavaScript
whyJavascript = Зашто је потребан JavaScript за Carreras Send?
