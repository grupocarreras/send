...
sendYourFilesLink = 试试 Carreras Send
...
notSupportedOutdatedDetail = 很可惜，此版本的 Firefox 不支持 Carreras Send 所使用的 Web 技术。您需要更新浏览器才能使用它。
...
javascriptRequired = Carreras Send 需要 JavaScript
whyJavascript = 为什么 Carreras Send 需要 JavaScript？
