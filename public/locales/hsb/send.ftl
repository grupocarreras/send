...
sendYourFilesLink = Carreras Send wupruwować
...
notSupportedOutdatedDetail = Bohužel tuta wersija Firefox webtechnologiju njepodpěruje, na kotrejž Carreras Send bazuje. Dyrbiće swój wobhladowak aktualizować.
...
javascriptRequired = Carreras Send JavaScript trjeba
whyJavascript = Čehodla Carreras Send JavaScript trjeba?
