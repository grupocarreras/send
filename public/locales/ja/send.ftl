...
sendYourFilesLink = Carreras Send を試す
...
notSupportedOutdatedDetail = 残念ながらお使いのバージョンの Firefox は Carreras Send が活用しているウェブ技術に対応していません。ブラウザーを更新する必要があります。
...
javascriptRequired = Carreras Send を使うには JavaScript が必要です
whyJavascript = Carreras Send が JavaScript を必要とする理由
