...
sendYourFilesLink = Δοκιμάστε το Carreras Send
...
notSupportedOutdatedDetail = Δυστυχώς, αυτή η έκδοση του Firefox δεν υποστηρίζει την τεχνολογία ιστού στην οποία βασίζεται το Carreras Send. Πρέπει να ενημερώσετε το πρόγραμμα περιήγησής σας.
...
javascriptRequired = Το Carreras Send απαιτεί JavaScript
whyJavascript = Γιατί το Carreras Send απαιτεί JavaScript;
