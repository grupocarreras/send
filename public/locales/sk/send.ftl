...
sendYourFilesLink = Vyskúšajte Carreras Send
...
notSupportedOutdatedDetail = Žiaľ, táto verzia Firefoxu nepodporuje webovú technológiu, ktorá poháňa Carreras Send. Budete musieť aktualizovať svoj prehliadač.
...
javascriptRequired = Carreras Send vyžaduje JavaScript
whyJavascript = Prečo Carreras Send vyžaduje JavaScript?
