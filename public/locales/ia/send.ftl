...
sendYourFilesLink = Proba Carreras Send
...
notSupportedOutdatedDetail = Infelicemente iste version de Firefox non supporta le nove technologia web que actiona Carreras Send. Tu debe actualisar tu navigator.
...
javascriptRequired = Carreras Send require JavaScript
whyJavascript = Proque Carreras Send require JavaScript?
