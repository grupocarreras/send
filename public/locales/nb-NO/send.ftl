...
sendYourFilesLink = Prøv Carreras Send
...
notSupportedOutdatedDetail = Dessverre støtter ikke denne versjonen av Firefox netteknologien som driver Carreras Send. Du trenger å oppdatere nettleseren din.
...
javascriptRequired = Carreras Send krever JavaScript.
whyJavascript = Hvorfor krever Carreras Send JavaScript?
