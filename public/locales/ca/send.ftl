...
sendYourFilesLink = Proveu el Carreras Send
...
notSupportedOutdatedDetail = Aquesta versió del Firefox no admet la tecnologia web amb què funciona el Carreras Send. Haureu d'actualitzar el navegador.
...
javascriptRequired = El Carreras Send necessita JavaScript
whyJavascript = Per què el Carreras Send necessita JavaScript?
...
-send-short-brand = Carreras Send
-firefox = Firefox
-mozilla = Mozilla
