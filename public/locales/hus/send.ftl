...
sendYourFilesLink = Ka eyendha' Carreras Send
...
notSupportedOutdatedDetail = Yab u awil ka eyendha' Carreras Send kom an NAVEGADOR Firefox biyalits. Ka Pa'ba' axi it.
...
javascriptRequired = Carreras Send in yejenchal JavaScript
whyJavascript = ¿Jale' Carreras Send in yejenchal JavaScript?
