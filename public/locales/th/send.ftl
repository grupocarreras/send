...
sendYourFilesLink = ลองใช้ Carreras Send
...
notSupportedOutdatedDetail = น่าเสียดายที่ Firefox รุ่นนี้ไม่สนับสนุนเทคโนโลยีเว็บที่ขับเคลื่อน Carreras Send คุณจะต้องอัปเดตเบราว์เซอร์ของคุณ
...
javascriptRequired = Carreras Send จำเป็นต้องใช้ JavaScript
whyJavascript = ทำไม Carreras Send จึงจำเป็นต้องใช้ JavaScript?
