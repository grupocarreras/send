...
sendYourFilesLink = Carreras Send Yoxla
...
notSupportedOutdatedDetail = Heyf ki, Firefox səyyahının bu versiyası Carreras Send-ə güc verən web texnologiyalarını dəstəkləmir. Səyyahınızı yeniləməlisiniz.
...
javascriptRequired = Carreras Send üçün JavaScript lazımdır
whyJavascript = Carreras Send niyə JavaScript tələb edir?
