...
sendYourFilesLink = Vyzkoušet Carreras Send
...
notSupportedOutdatedDetail = Tato verze Firefoxu bohužel nepodporuje webovou technologii, která pohání Carreras Send. Musíte aktualizovat svůj prohlížeč.
...
javascriptRequired = Carreras Send vyžaduje povolený JavaScript
whyJavascript = Proč Carreras Send vyžaduje povolený JavaScript?
