...
sendYourFilesLink = გამოცადეთ Carreras Send
...
notSupportedOutdatedDetail = სამწუხაროდ, Firefox-ის ამ ვერსიას არ გააჩნია ის ტექნოლოგია, რომელიც აუცილებელია Carreras Send-ის მუშაობისთვის. გესაჭიროებათ, ბრაუზერის განახლება.
...
javascriptRequired = Carreras Send საჭიროებს JavaScript-ს
whyJavascript = რატომ საჭიროებს Carreras Send JavaScript-ს?
