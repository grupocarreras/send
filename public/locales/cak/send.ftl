...
sendYourFilesLink = Titojtob'ëx Carreras Send
...
notSupportedOutdatedDetail = K'ayew ruma re ruwäch Firefox re' man nuköch' ta ri ajk'amaya'l na'ob'äl nrajo' ri Carreras Send. Rajowaxik nak'ëx ri awokik'amaya'l.
...
javascriptRequired = K'atzinel JavaScript chi re ri Carreras Send
whyJavascript = ¿Achike ruma toq ri Carreras Send nrajo' JavaScript?
