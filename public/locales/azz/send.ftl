...
sendYourFilesLink = Xikejeko Carreras Send
...
notSupportedOutdatedDetail = Tetayokoltij, Firefox tein tikuitok amo kiselia tepostekitilis tecnología web tein ika tekiti Carreras Send. Moneki tikyankuilis monavegador.
...
javascriptRequired = Carreras Send kineki maj moajsi JavaScript
whyJavascript = ¿Keyej Carreras Send kineki maj moajsi JavaScript?
