...
sendYourFilesLink = Паспрабуйце Carreras Send
...
notSupportedOutdatedDetail = На жаль, гэтая версія Firefox не падтрымлівае вэб-тэхналогію, што забяспечвае працу Carreras Send. Вам трэба абнавіць свой браўзер.
...
javascriptRequired = Для Carreras Send неабходны JavaScript
whyJavascript = Чаму для Carreras Send неабходны JavaScript?
