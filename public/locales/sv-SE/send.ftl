...
sendYourFilesLink = Testa Carreras Send
...
notSupportedOutdatedDetail = Tyvärr stödjer den här versionen av Firefox inte webbtekniken som driver Carreras Send. Du måste uppdatera din webbläsare.
...
javascriptRequired = Carreras Send kräver JavaScript
whyJavascript = Varför kräver Carreras Send JavaScript?
