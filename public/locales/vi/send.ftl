...
sendYourFilesLink = Dùng thử Carreras Send
...
notSupportedOutdatedDetail = Thật không may là phiên bản Firefox này không hỗ trợ công nghệ được sử dụng trong Carreras Send. Bạn cần cập nhật trình duyệt của bạn.
...
javascriptRequired = Carreras Send cần JavaScript
whyJavascript = Tại sao Carreras Send cần JavaScript?
